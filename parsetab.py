...
_lr_productions = [
  ...
  ('prog -> vardecls procdecls BEGIN stmtlist END','prog',5,'p_prog','parser.py',28),
  ('empty -> <empty>','empty',0,'p_empty','parser.py',39),
  ('vardecls -> vardecl vardecls','vardecls',2,'p_vardecls','parser.py',44),
  ('vardecls -> empty','vardecls',1,'p_vardecls','parser.py',45),
  ('vardecl -> VAR varlist SEMICOLON','vardecl',3,'p_vardecl','parser.py',58),
  ('varlist -> ID COMMA varlist','varlist',3,'p_varlist','parser.py',65),
  ('varlist -> ID','varlist',1,'p_varlist','parser.py',66),
  ('procdecls -> procdecl procdecls','procdecls',2,'p_procdecls','parser.py',76),
  ('procdecls -> empty','procdecls',1,'p_procdecls','parser.py',77),
  ('procdecl -> PROC ID LPAREN paramlist RPAREN vardecls pstmtlist','procdecl',7,'p_procdecl','parser.py',90),
  ('paramlist -> tparamlist','paramlist',1,'p_paramlist','parser.py',120),
  ('paramlist -> empty','paramlist',1,'p_paramlist','parser.py',121),
  ('tparamlist -> param COMMA tparamlist','tparamlist',3,'p_tparamlist','parser.py',128),
  ('tparamlist -> param','tparamlist',1,'p_tparamlist','parser.py',129),
  ('param -> mode ID','param',2,'p_param','parser.py',140),
  ('mode -> IN','mode',1,'p_mode','parser.py',148),
  ('mode -> OUT','mode',1,'p_mode','parser.py',149),
  ('mode -> INOUT','mode',1,'p_mode','parser.py',150),
  ('pstmtlist -> pstmt pstmtlist','pstmtlist',2,'p_pstmtlist','parser.py',156),
  ('pstmtlist -> pstmt','pstmtlist',1,'p_pstmtlist','parser.py',157),
  ('stmtlist -> mstmt stmtlist','stmtlist',2,'p_stmtlist','parser.py',167),
  ('stmtlist -> mstmt','stmtlist',1,'p_stmtlist','parser.py',168),
  ('pstmt -> DLABEL','pstmt',1,'p_pstmt','parser.py',178),
  ('pstmt -> stmt SEMICOLON','pstmt',2,'p_pstmt','parser.py',179),
  ('pstmt -> RETURN SEMICOLON','pstmt',2,'p_pstmt','parser.py',180),
  ('mstmt -> DLABEL','mstmt',1,'p_mstmt','parser.py',187),
  ('mstmt -> stmt SEMICOLON','mstmt',2,'p_mstmt','parser.py',188),
  ('stmt -> assign','stmt',1,'p_stmt','parser.py',195),
  ('stmt -> condjump','stmt',1,'p_stmt','parser.py',196),
  ('stmt -> jump','stmt',1,'p_stmt','parser.py',197),
  ('stmt -> readstmt','stmt',1,'p_stmt','parser.py',198),
  ('stmt -> printstmt','stmt',1,'p_stmt','parser.py',199),
  ('stmt -> callstmt','stmt',1,'p_stmt','parser.py',200),
  ('stmt -> EXIT','stmt',1,'p_stmt','parser.py',201),
  ('assign -> ID EQUALS opd arithop opd','assign',5,'p_assign','parser.py',208),
  ('condjump -> IF ID cmpop ID GOTO LABEL','condjump',6,'p_condjump','parser.py',214),
  ('jump -> GOTO LABEL','jump',2,'p_jump','parser.py',227),
  ('readstmt -> READ ID','readstmt',2,'p_readstmt','parser.py',236),
  ('printstmt -> PRINT printarg','printstmt',2,'p_printstmt','parser.py',242),
  ('printstmt -> PRINTLN','printstmt',1,'p_printstmt','parser.py',243),
  ('printarg -> ID','printarg',1,'p_printarg','parser.py',252),
  ('printarg -> STRING','printarg',1,'p_printarg','parser.py',253),
  ('callstmt -> CALL ID LPAREN arglist RPAREN','callstmt',5,'p_callstmt','parser.py',259),
  ('arglist -> targlist','arglist',1,'p_arglist','parser.py',265),
  ('arglist -> empty','arglist',1,'p_arglist','parser.py',266),
  ('targlist -> ID COMMA targlist','targlist',3,'p_targlist','parser.py',272),
  ('targlist -> ID','targlist',1,'p_targlist','parser.py',273),
  ('cmpop -> LESSER','cmpop',1,'p_cmpop','parser.py',282),
  ('cmpop -> GREATER','cmpop',1,'p_cmpop','parser.py',283),
  ('cmpop -> LEQ','cmpop',1,'p_cmpop','parser.py',284),
  ('cmpop -> GEQ','cmpop',1,'p_cmpop','parser.py',285),
  ('cmpop -> EQUALS','cmpop',1,'p_cmpop','parser.py',286),
  ('cmpop -> NEQ','cmpop',1,'p_cmpop','parser.py',287),
  ('arithop -> PLUS','arithop',1,'p_airthop','parser.py',292),
  ('arithop -> MINUS','arithop',1,'p_airthop','parser.py',293),
  ('arithop -> MULTIPLY','arithop',1,'p_airthop','parser.py',294),
  ('arithop -> DIVIDE','arithop',1,'p_airthop','parser.py',295),
  ('opd -> ID','opd',1,'p_opd','parser.py',302),
  ('opd -> NUM','opd',1,'p_opd','parser.py',303),
]
