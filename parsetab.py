...
_lr_productions = [
  ...
  ('vardecls -> vardecl vardecls','vardecls',2,'p_vardecls','parser.py',38),
  ('vardecls -> empty','vardecls',1,'p_vardecls','parser.py',39),
  ('vardecl -> VAR varlist SEMICOLON','vardecl',3,'p_vardecl','parser.py',51),
  ('varlist -> ID COMMA varlist','varlist',3,'p_varlist','parser.py',57),
  ('varlist -> ID','varlist',1,'p_varlist','parser.py',58),
  ('procdecls -> procdecl procdecls','procdecls',2,'p_procdecls','parser.py',67),
  ('procdecls -> empty','procdecls',1,'p_procdecls','parser.py',68),
  ('procdecl -> PROC ID LPAREN paramlist RPAREN vardecls pstmtlist','procdecl',7,'p_procdecl','parser.py',81),
  ('paramlist -> tparamlist','paramlist',1,'p_paramlist','parser.py',97),
  ('paramlist -> empty','paramlist',1,'p_paramlist','parser.py',98),
  ('tparamlist -> param COMMA tparamlist','tparamlist',3,'p_tparamlist','parser.py',104),
  ('tparamlist -> param','tparamlist',1,'p_tparamlist','parser.py',105),
  ('param -> mode ID','param',2,'p_param','parser.py',114),
  ('mode -> IN','mode',1,'p_mode','parser.py',120),
  ('mode -> OUT','mode',1,'p_mode','parser.py',121),
  ('mode -> INOUT','mode',1,'p_mode','parser.py',122),
  ('pstmtlist -> pstmt pstmtlist','pstmtlist',2,'p_pstmtlist','parser.py',128),
  ('pstmtlist -> pstmt','pstmtlist',1,'p_pstmtlist','parser.py',129),
  ('stmtlist -> mstmt stmtlist','stmtlist',2,'p_stmtlist','parser.py',138),
  ('stmtlist -> mstmt','stmtlist',1,'p_stmtlist','parser.py',139),
  ('pstmt -> DLABEL','pstmt',1,'p_pstmt','parser.py',148),
  ('pstmt -> stmt SEMICOLON','pstmt',2,'p_pstmt','parser.py',149),
  ('pstmt -> RETURN SEMICOLON','pstmt',2,'p_pstmt','parser.py',150),
  ('mstmt -> DLABEL','mstmt',1,'p_mstmt','parser.py',156),
  ('mstmt -> stmt SEMICOLON','mstmt',2,'p_mstmt','parser.py',157),
  ('stmt -> assign','stmt',1,'p_stmt','parser.py',163),
  ('stmt -> condjump','stmt',1,'p_stmt','parser.py',164),
  ('stmt -> jump','stmt',1,'p_stmt','parser.py',165),
  ('stmt -> readstmt','stmt',1,'p_stmt','parser.py',166),
  ('stmt -> printstmt','stmt',1,'p_stmt','parser.py',167),
  ('stmt -> callstmt','stmt',1,'p_stmt','parser.py',168),
  ('stmt -> EXIT','stmt',1,'p_stmt','parser.py',169),
  ('assign -> ID EQUALS opd arithop opd','assign',5,'p_assign','parser.py',175),
  ('condjump -> IF ID cmpop ID GOTO LABEL','condjump',6,'p_condjump','parser.py',181),
  ('jump -> GOTO LABEL','jump',2,'p_jump','parser.py',191),
  ('readstmt -> READ ID','readstmt',2,'p_readstmt','parser.py',197),
  ('printstmt -> PRINT printarg','printstmt',2,'p_printstmt','parser.py',203),
  ('printstmt -> PRINTLN','printstmt',1,'p_printstmt','parser.py',204),
  ('printarg -> ID','printarg',1,'p_printarg','parser.py',213),
  ('printarg -> STRING','printarg',1,'p_printarg','parser.py',214),
  ('callstmt -> CALL ID LPAREN arglist RPAREN','callstmt',5,'p_callstmt','parser.py',220),
  ('arglist -> targlist','arglist',1,'p_arglist','parser.py',226),
  ('arglist -> empty','arglist',1,'p_arglist','parser.py',227),
  ('targlist -> ID COMMA targlist','targlist',3,'p_targlist','parser.py',233),
  ('targlist -> ID','targlist',1,'p_targlist','parser.py',234),
  ('cmpop -> LESSER','cmpop',1,'p_cmpop','parser.py',243),
  ('cmpop -> GREATER','cmpop',1,'p_cmpop','parser.py',244),
  ('cmpop -> LEQ','cmpop',1,'p_cmpop','parser.py',245),
  ('cmpop -> GEQ','cmpop',1,'p_cmpop','parser.py',246),
  ('cmpop -> EQUALS','cmpop',1,'p_cmpop','parser.py',247),
  ('cmpop -> NEQ','cmpop',1,'p_cmpop','parser.py',248),
  ('arithop -> PLUS','arithop',1,'p_airthop','parser.py',253),
  ('arithop -> MINUS','arithop',1,'p_airthop','parser.py',254),
  ('arithop -> MULTIPLY','arithop',1,'p_airthop','parser.py',255),
  ('arithop -> DIVIDE','arithop',1,'p_airthop','parser.py',256),
  ('opd -> ID','opd',1,'p_opd','parser.py',263),
  ('opd -> NUM','opd',1,'p_opd','parser.py',264),
]
